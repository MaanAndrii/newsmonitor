...
## Базовий реліз
- Поточний базовий реліз: **5.0Rc**.
- Цей стан вважається опорною стабільною версією для подальших змін.
...
- Базова релізна точка: **5.0Rc**.
- Подальші зміни мають підвищувати версію відносно `5.0Rc` за прийнятою командою схемою релізів.
